...
const FilterSideBar = ({filterPhone,setFilterPhone,filters,setFilters,})=> {
...
const onClearFliter = ()=>{
  ...
  return (
    <div
      className={` ${
        filterPhone ? "max-sm:fixed" : "max-sm:hidden"
    ...
    >
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <X onClick={onClearFliter} className="size-6 text-gray-500 hover:text-gray-700 p-1 hover:bg-gray-100 rounded transition-colors cursor-pointer" />
          <button
            onClick={() => setFilterPhone(false)}
            className="border sm:hidden text-sm text-gray-700 px-3 py-1 rounded"
          >
            Apply
          </button>
        </div>
      ...
      <div className="p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar">
        ...
        <div>
          ...
          {expandedSections.followers && (
            ...
            className="w-full px-3 py-2 border-gray-300 rounded-lg text-gray-700 outline-indigo-500"
            >
