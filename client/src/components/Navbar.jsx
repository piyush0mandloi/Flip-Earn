...
import { BoxIcon, GripIcon, ListIcon, MenuIcon, MessageCircleMoreIcon } from "lucide-react";
        ...
        >
          <div className="flex flex-col items-center justify-center h-full text-xl font-semibold gap-6 p-4">
            ...
            <MenuIcon
              ...
              className="absolute size-8 right-6 text-gray-500 hover:text-gray-700 cursor-pointer"
            />
          </div>
        </div>
      </nav>
