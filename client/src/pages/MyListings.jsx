  ...
  return (
    <div className='px-6 md:mx-16 lg:px-24 xl:px-32 pt-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
        ...
        <StatCard title='Total Listings' value={soldListings} icon={ <TrendingUp className='size-6 text-indigo-600' />} color='indigo'/>
        <StatCard title='Total Listings' value={`${currency}${totalValue.toLocaleString()}`} icon={ <DollarSign className='size-6 text-yellow-600'  />} color='yellow'/>
      </div>
...
<div className='bg-white rounded-lg border border-gray-200 p-16 text-center'>
  ...
  <button className='bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg font-medium'>Create First Listing</button>
</div>
    ) :
    (
              ...
              <div className='flex items-center gap-2'>
                ...
                <div className='invisible group-hover:visible absolute right-0 top-0 pt-4.5 z-10'>
                  <div className='bg-white text-gray-600 text-xs rounded border border-gray-200 p-2 px-3'>
                    ...
                    <button className='text-nowrap'>Status:{" "}
                      <span className={
                        listing.isCredentialSubmitted
